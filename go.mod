module github.com/Mellanox/spectrum-x-operator

go 1.24

require (
	github.com/Mellanox/nvidia-k8s-ipam v0.3.6
...
require (
	...
	github.com/openshift/api v0.0.0-20250129172457-b1a9b9a2e7fe // indirect
	...
	github.com/openshift/machine-config-operator v0.0.1-0.20250304041132-19ba3dda6e7a // indirect
...
replace github.com/k8snetworkplumbingwg/sriov-network-operator => github.com/e0ne/sriov-network-operator v0.0.0-20250324122154-467699583151
