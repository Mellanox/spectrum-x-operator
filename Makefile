...
# nvidia.com/spectrum-x-operator-bundle:$VERSION and nvidia.com/spectrum-x-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= nvidia.com/spectrum-x-operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name spectrum-x-operator-builder
	$(CONTAINER_TOOL) buildx use spectrum-x-operator-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm spectrum-x-operator-builder
	rm Dockerfile.cross
